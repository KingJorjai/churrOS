...
run_test \
    ...
    "./build/churros -a rr -c 1 -o 1 -t 1 -p 4 -g 5 -s 50 -d 50" \
...
run_test \
    ...
    "./build/churros -a rr -c 1 -o 1 -t 2 -p 2 -g 6 -s 50 -d 40" \
...
run_test \
    ...
    "./build/churros -a rr -c 1 -o 2 -t 2 -p 5 -g 4 -s 30 -d 60" \
...
run_test \
    ...
    "./build/churros -a fifo -c 1 -o 1 -t 1 -p 4 -g 5 -s 50 -d 50" \
...
# Test 2.2: FIFO con Timer Rápido (Verificar que Timer no Causa Preemption)
run_test \
    "Test 2.2: FIFO - Timer Rápido Sin Efecto" \
    "Timer rápido NO debe causar preemption en FIFO" \
    "./build/churros -a fifo -c 1 -o 1 -t 2 -p 2 -g 6 -s 50 -d 40" \
    "MUST_HAVE:FIFO:Confirma que usa FIFO|MUST_NOT_HAVE:Preemption:Timer rápido NO debe causar preemption|MUST_HAVE:Dispatch:Debe haber dispatches solo por terminación"

# Test 2.3: FIFO Multicore
run_test \
    "Test 2.3: FIFO - Distribución Multicore" \
    "Múltiples hilos procesando con FIFO sin rotación" \
    "./build/churros -a fifo -c 1 -o 2 -t 2 -p 5 -g 4 -s 30 -d 60" \
...
run_test \
    ...
    "./build/churros -a rr -c 1 -o 1 -t 1 -p 3 -g 2 -s 30 -d 50" \
    "MUST_HAVE:Round Robin:Usa Round Robin|COUNT_MIN:Preemption:Debe rotar entre procesos activamente:8|MUST_HAVE:Dispatch:Debe despachar procesos"
...
run_test \
    ...
    "./build/churros -a fifo -c 1 -o 1 -t 1 -p 3 -g 2 -s 30 -d 50" \
...
run_test \
    ...
    "./build/churros -a rr -c 1 -o 1 -t 2 -p 1 -g 3 -s 20 -d 30" \
    "MUST_HAVE:Round Robin:Usa Round Robin|COUNT_MIN:Preemption:Debe haber muchos context switches:10|MUST_HAVE:Scheduler:Scheduler muy activo"
...
run_test \
    ...
    "./build/churros -a fifo -c 1 -o 1 -t 2 -p 1 -g 3 -s 20 -d 30" \
...
run_test \
    ...
    "Generación rápida de procesos con quantum moderado" \
    "./build/churros -a rr -c 1 -o 2 -t 1 -p 6 -g 2 -s 20 -d 80" \
    "MUST_HAVE:Round Robin:Usa Round Robin|COUNT_MIN:creado:Debe generar múltiples procesos:15|MUST_HAVE:Scheduler:Scheduler debe manejar la cola"

# Test 4.2: Saturación de Cola - FIFO
run_test \
    "Test 4.2: Saturación - FIFO" \
    "Mismo escenario que 4.1 pero con FIFO" \
    "./build/churros -a fifo -c 1 -o 2 -t 1 -p 6 -g 2 -s 20 -d 80" \
    "MUST_HAVE:FIFO:Usa FIFO|COUNT_MIN:creado:Debe generar múltiples procesos:15|MUST_NOT_HAVE:Preemption:No debe haber preemption por tiempo"
...
run_test \
    ...
    "./build/churros -a rr -c 2 -o 2 -t 2 -p 8 -g 5 -s 20 -d 100" \
